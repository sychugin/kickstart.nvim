...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- NOTE: LSP reference highlighting on cursor hold is handled by `snacks.words`
          -- (see lua/custom/plugins/snacks.lua) instead of a manual CursorHold autocmd here.
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --  NOTE: Prefix moved from `s` to `gs` so it doesn't collide with flash.nvim's jump keys
      --
